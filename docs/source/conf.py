# -*- coding: utf-8 -*-
#
# DIMS System Requirements documentation build configuration file, created by
...
project = u'DIMS System Requirements'
...
htmlhelp_basename = 'DIMSSystemRequirementsdoc'
...
latex_documents = [
  ('index', 'DIMSSystemRequirements.tex', u'DIMS System Requirements Documentation',
...
man_pages = [
    ('index', 'dimssr', u'DIMS System Requirements Documentation',
     [u'David Dittrich'], 1)
]
...
texinfo_documents = [
  ('index', 'DIMSSystemRequirements', u'DIMS System Requirements Documentation',
   u'David Dittrich', 'DIMSSystemRequirements', 'One line description of project.',
   'Miscellaneous'),
]
